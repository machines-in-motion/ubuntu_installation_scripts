...
VERSION=5.2.19
VERSION_PATCH=5.2.19-rt11
DEFAULT_CONFIG=/boot/config-5.2.19-050219-generic
...
sudo apt-get install -y libelf-dev libncurses5-dev libssl-dev bison flex kernel-package
...
wget -nc https://mirrors.edge.kernel.org/pub/linux/kernel/v5.x/linux-$VERSION.tar.xz
wget -nc http://cdn.kernel.org/pub/linux/kernel/projects/rt/5.2/older/patch-$VERSION_PATCH.patch.xz
